            ...
            <Button variant={"outline"} className='w-full' onClick={signInWithGoogle}>
                {
                    isLoading ? (
                        ...
                        <>
                            <GoogleSvg /><p>Continue with Google</p>
                        </>
                    )
                }
            </Button>
...
export const GoogleSvg = () => {
    return (
        <svg stroke="currentColor" fill="currentColor" strokeWidth="0" version="1.1" x="0px" y="0px" viewBox="0 0 48 48" enableBackground="new 0 0 48 48" height="200px" width="200px" xmlns="http://www.w3.org/2000/svg"><path fill="#FFC107" d="M43.611,20.083H42V20H24v8h11.303c-1.649,4.657-6.08,8-11.303,8c-6.627,0-12-5.373-12-12
