    ...
    <AnimatePresence >
      {isCardVisible && (
        <motion.div
          ...
          animate={{ opacity: 1, scale: 1, x: 0, y: [-50, -55,-55, 50, 45, 30, 0] }}
        ...
        >
          ...
          <ul className="space-y-4">
            <li className="text-md cursor-pointer hover:text-gray-700">Home</li>
      ...
      <div onClick={()=>setIsCardVisible(!isCardVisible)} className="md:hidden flex">
        <TbMenu color="white" size={25}/>
      </div>
    </AnimatePresence>
  );
}
